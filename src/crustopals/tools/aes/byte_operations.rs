...
pub fn s_box(byte: u8) -> u8 {
    let s_box_matrix = [
        ...
        [
            "ca", "82", "c9", "7d", "fa", "59", "47", "f0", "ad", "d4", "a2", "af", "9c", "a4",
            "72", "c0",
        ],
        [
    ...
    let first_digit = (byte / 16) as usize;
    let second_digit = (byte % 16) as usize;
    hex::decode(s_box_matrix[first_digit][second_digit]).unwrap()[0]
}

pub fn inv_s_box(byte: u8) -> u8 {
    let inv_s_box_matrix = [
        [
            "52", "09", "6a", "d5", "30", "36", "a5", "38", "bf", "40", "a3", "9e", "81", "f3",
            "d7", "fb",
        ],
        [
            "7c", "e3", "39", "82", "9b", "2f", "ff", "87", "34", "8e", "43", "44", "c4", "de",
            "e9", "cb",
        ],
        [
            "54", "7b", "94", "32", "a6", "c2", "23", "3d", "ee", "4c", "95", "0b", "42", "fa",
            "c3", "4e",
        ],
        [
        ...
        [
            "90", "d8", "ab", "00", "8c", "bc", "d3", "0a", "f7", "e4", "58", "05", "b8", "b3",
            "45", "06",
        ],
        [
        ...
        [
            "47", "f1", "1a", "71", "1d", "29", "c5", "89", "6f", "b7", "62", "0e", "aa", "18",
            "be", "1b",
        ],
        [
            "fc", "56", "3e", "4b", "c6", "d2", "79", "20", "9a", "db", "c0", "fe", "78", "cd",
            "5a", "f4",
        ],
        [
        ...
        [
            "60", "51", "7f", "a9", "19", "b5", "4a", "0d", "2d", "e5", "7a", "9f", "93", "c9",
            "9c", "ef",
        ],
        [
        ...
        [
            "17", "2b", "04", "7e", "ba", "77", "d6", "26", "e1", "69", "14", "63", "55", "21",
            "0c", "7d",
        ],
    ];
    let first_digit = (byte / 16) as usize;
    let second_digit = (byte % 16) as usize;
    hex::decode(inv_s_box_matrix[first_digit][second_digit]).unwrap()[0]
}
...
mod tests {
    ...
    #[test]
    fn returns_the_byte_translated_through_sbox() {
        let byte = hex::decode("92").unwrap()[0];
        let sbox_output_byte = hex::decode("4f").unwrap()[0];
        let s_output = s_box(byte);

        assert_eq!(s_output, sbox_output_byte);
    }
}
