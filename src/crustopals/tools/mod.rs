...
pub fn strip_pkcs7_padding(mut decrypted_bytes: Vec<u8>) -> Result<Vec<u8>, String> {
...
mod tests {
    ...
    fn convert_hex_to_base64() {
        let hex = "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e\
